...
def makeUnary(module: BinaryenModuleRef, op: BinaryenOp, inputType: BinaryenType) -> BinaryenExpressionRef:
    if inputType == BinaryenTypeInt32():
        return BinaryenUnary(module, op, BinaryenConst(module, BinaryenLiteralInt32(-10)))
    if inputType == BinaryenTypeInt64():
        return BinaryenUnary(module, op, BinaryenConst(module, BinaryenLiteralInt64(-22)))
    if inputType == BinaryenTypeFloat32():
        return BinaryenUnary(module, op, BinaryenConst(module, BinaryenLiteralFloat32(-33.612)))
    if inputType == BinaryenTypeFloat64():
        return BinaryenUnary(module, op, BinaryenConst(module, BinaryenLiteralFloat64(-9005.841)))
    if inputType == BinaryenTypeVec128():
        return BinaryenUnary(module, op, BinaryenConst(module, BinaryenLiteralVec128(v128_bytes)))
    abort()
...
def makeBinary(module: BinaryenModuleRef, op: BinaryenOp, type: BinaryenType) -> BinaryenExpressionRef:
    ...
    if type == BinaryenTypeFloat32():
        temp = BinaryenConst(module, BinaryenLiteralFloat32(-62.5))
        return BinaryenBinary(module, op, BinaryenConst(module, BinaryenLiteralFloat32(-33.612)), temp)
...
def makeFloat64(module: BinaryenModuleRef, x: float) -> BinaryenExpressionRef:
    return BinaryenConst(module, BinaryenLiteralFloat64(x))


def makeVec128(module: BinaryenModuleRef, bytes: bytes) -> BinaryenExpressionRef:
...
def makeSIMDReplace(module: BinaryenModuleRef, op: BinaryenOp, type: BinaryenType) -> BinaryenExpressionRef:
    ...
    if type == BinaryenTypeFloat32():
        val = makeFloat32(module, 42.0)
    if type == BinaryenTypeFloat64():
        val = makeFloat64(module, 42.0)
    if not val:
        abort()
...
def makeSIMDShuffle(module: BinaryenModuleRef) -> BinaryenExpressionRef:
    ...
    return BinaryenSIMDShuffle(module, left, right, bytes([0] * 16))
...
def test_types() -> None:
    ...
    assert BinaryenHeapTypeGetBottom(BinaryenHeapTypeExt()) == BinaryenHeapTypeNoext()
...
def test_core() -> None:
    ...
    # constF32Bits = BinaryenConst(module, BinaryenLiteralFloat32Bits(4294906420)) <- TODO: overflow
    # constF64Bits = BinaryenConst(module, BinaryenLiteralFloat64Bits(18446482614731189197)) <- TODO: overflow
    ...
    callOperands4 = [makeInt32(module, 13), makeInt64(module, 37), makeFloat32(module, 1.3), makeFloat64(module, 3.7)]
    callOperands4b = [makeInt32(module, 13), makeInt64(module, 37), makeFloat32(module, 1.3), makeFloat64(module, 3.7)]
    tupleElements4a = [makeInt32(module, 13), makeInt64(module, 37), makeFloat32(module, 1.3), makeFloat64(module, 3.7)]
    tupleElements4b = [makeInt32(module, 13), makeInt64(module, 37), makeFloat32(module, 1.3), makeFloat64(module, 3.7)]
    iIfF_ = [BinaryenTypeInt32(), BinaryenTypeInt64(), BinaryenTypeFloat32(), BinaryenTypeFloat64()]
    ...
    tryBody = BinaryenThrow(module, 'a-tag', [makeInt32(module, 0)])
    ...
    TypeBuilderSetArrayType(tb, 0, BinaryenTypeInt32(), BinaryenPackedTypeInt8(), True)
    TypeBuilderSetArrayType(tb, 1, BinaryenTypeInt32(), BinaryenPackedTypeInt16(), True)
    TypeBuilderSetStructType(tb, 2, [BinaryenTypeInt32()], [BinaryenPackedTypeNotPacked()], [True])
    result, errorCode, errorReason = TypeBuilderBuildAndDispose(tb, builtHeapTypes := [])
    ...
    segmentOffsets = [BinaryenConst(module, BinaryenLiteralInt32(10)), None]
    segmentSizes = [12, 12]
    BinaryenSetMemory(module, 1, 256, 'mem', segments, segmentPassive, segmentOffsets, segmentSizes, True, False, '0')
    valueList = [
        ...
        BinaryenSIMDLoad(module, BinaryenLoad8SplatVec128(), 0, 1, makeInt32(module, 128), '0'),
        BinaryenSIMDLoad(module, BinaryenLoad16SplatVec128(), 16, 1, makeInt32(module, 128), '0'),
        BinaryenSIMDLoad(module, BinaryenLoad32SplatVec128(), 16, 4, makeInt32(module, 128), '0'),
        BinaryenSIMDLoad(module, BinaryenLoad64SplatVec128(), 0, 4, makeInt32(module, 128), '0'),
        BinaryenSIMDLoad(module, BinaryenLoad8x8SVec128(), 0, 8, makeInt32(module, 128), '0'),
        BinaryenSIMDLoad(module, BinaryenLoad8x8UVec128(), 0, 8, makeInt32(module, 128), '0'),
        BinaryenSIMDLoad(module, BinaryenLoad16x4SVec128(), 0, 8, makeInt32(module, 128), '0'),
        BinaryenSIMDLoad(module, BinaryenLoad16x4UVec128(), 0, 8, makeInt32(module, 128), '0'),
        BinaryenSIMDLoad(module, BinaryenLoad32x2SVec128(), 0, 8, makeInt32(module, 128), '0'),
        BinaryenSIMDLoad(module, BinaryenLoad32x2UVec128(), 0, 8, makeInt32(module, 128), '0'),
        BinaryenSIMDLoad(module, BinaryenLoad32ZeroVec128(), 0, 4, makeInt32(module, 128), '0'),
        BinaryenSIMDLoad(module, BinaryenLoad64ZeroVec128(), 0, 8, makeInt32(module, 128), '0'),
        BinaryenSIMDLoadStoreLane(
            module, BinaryenLoad8LaneVec128(), 0, 1, 0, makeInt32(module, 128), makeVec128(module, v128_bytes), '0'
        ),
        BinaryenSIMDLoadStoreLane(
            module, BinaryenLoad16LaneVec128(), 0, 2, 0, makeInt32(module, 128), makeVec128(module, v128_bytes), '0'
        ),
        BinaryenSIMDLoadStoreLane(
            module, BinaryenLoad32LaneVec128(), 0, 4, 0, makeInt32(module, 128), makeVec128(module, v128_bytes), '0'
        ),
        BinaryenSIMDLoadStoreLane(
            module, BinaryenLoad64LaneVec128(), 0, 8, 0, makeInt32(module, 128), makeVec128(module, v128_bytes), '0'
        ),
        BinaryenSIMDLoadStoreLane(
            module, BinaryenStore8LaneVec128(), 0, 1, 0, makeInt32(module, 128), makeVec128(module, v128_bytes), '0'
        ),
        BinaryenSIMDLoadStoreLane(
            module, BinaryenStore16LaneVec128(), 0, 2, 0, makeInt32(module, 128), makeVec128(module, v128_bytes), '0'
        ),
        BinaryenSIMDLoadStoreLane(
            module, BinaryenStore32LaneVec128(), 0, 4, 0, makeInt32(module, 128), makeVec128(module, v128_bytes), '0'
        ),
        BinaryenSIMDLoadStoreLane(
            module, BinaryenStore64LaneVec128(), 0, 8, 0, makeInt32(module, 128), makeVec128(module, v128_bytes), '0'
        ),
        ...
        BinaryenBlock(module, None, None, BinaryenTypeAuto()),
        ...
        BinaryenSwitch(module, switchBodyNames, 'the-nothing', makeInt32(module, 2), None),
        BinaryenUnary(
            module, BinaryenEqZInt32(), BinaryenCall(module, 'kitchen()sinker', callOperands4, BinaryenTypeInt32())
        ),
        BinaryenUnary(
            module,
            BinaryenEqZInt32(),
            BinaryenUnary(
                ...
                BinaryenCall(module, 'an-imported', callOperands2, BinaryenTypeFloat32()),
            ),
        ),
        BinaryenUnary(
            module,
            BinaryenEqZInt32(),
            BinaryenCallIndirect(module, 'tab', makeInt32(module, 2449), callOperands4b, iIfF, BinaryenTypeInt32()),
        ),
        BinaryenDrop(module, BinaryenLocalGet(module, 0, BinaryenTypeInt32())),
        BinaryenLocalSet(module, 0, makeInt32(module, 101)),
        BinaryenDrop(module, BinaryenLocalTee(module, 0, makeInt32(module, 102), BinaryenTypeInt32())),
        BinaryenLoad(module, 4, False, 0, 0, BinaryenTypeInt32(), makeInt32(module, 1), '0'),
        BinaryenLoad(module, 2, True, 2, 1, BinaryenTypeInt64(), makeInt32(module, 8), '0'),
        BinaryenLoad(module, 4, False, 0, 0, BinaryenTypeFloat32(), makeInt32(module, 2), '0'),
        BinaryenLoad(module, 8, False, 2, 8, BinaryenTypeFloat64(), makeInt32(module, 9), '0'),
        ...
        BinaryenReturnCall(module, 'kitchen()sinker', callOperands4, BinaryenTypeInt32()),
        BinaryenReturnCallIndirect(module, 'tab', makeInt32(module, 2449), callOperands4b, iIfF, BinaryenTypeInt32()),
        ...
        BinaryenRefEq(
            module, BinaryenRefNull(module, BinaryenTypeNullref()), BinaryenRefNull(module, BinaryenTypeNullref())
        ),
        BinaryenRefAs(module, BinaryenRefAsNonNull(), BinaryenRefNull(module, BinaryenTypeNullref())),
        BinaryenRefAs(module, BinaryenRefAsExternInternalize(), BinaryenRefNull(module, BinaryenTypeNullExternref())),
        BinaryenRefAs(module, BinaryenRefAsExternExternalize(), BinaryenRefNull(module, BinaryenTypeNullref())),
        BinaryenTry(module, None, tryBody, catchTags, catchBodies, None),
        BinaryenTry(
            module,
            'try_outer',
            BinaryenTry(module, None, tryBody, emptyCatchTags, emptyCatchBodies, 'try_outer'),
            emptyCatchTags,
            nopCatchBody,
            None,
        ),
        ...
        BinaryenDrop(module, BinaryenAtomicWait(module, temp6, temp6, temp16, BinaryenTypeInt32(), '0')),
        ...
        BinaryenTupleExtract(module, BinaryenTupleMake(module, tupleElements4b), 2),
        ...
        BinaryenRefTest(module, BinaryenGlobalGet(module, 'i8Array-global', i8Array), i8Array),
        BinaryenRefCast(module, BinaryenGlobalGet(module, 'i8Array-global', i8Array), i8Array),
        BinaryenStructNew(module, None, BinaryenTypeGetHeapType(i32Struct)),
        BinaryenStructNew(module, [makeInt32(module, 0)], BinaryenTypeGetHeapType(i32Struct)),
        BinaryenStructGet(
            module, 0, BinaryenGlobalGet(module, 'i32Struct-global', i32Struct), BinaryenTypeInt32(), False
        ),
        BinaryenStructSet(module, 0, BinaryenGlobalGet(module, 'i32Struct-global', i32Struct), makeInt32(module, 0)),
        BinaryenArrayNew(module, BinaryenTypeGetHeapType(i8Array), makeInt32(module, 3), None),
        BinaryenArrayNew(module, BinaryenTypeGetHeapType(i8Array), makeInt32(module, 3), makeInt32(module, 42)),
        BinaryenArrayNewFixed(
            module, BinaryenTypeGetHeapType(i8Array), [makeInt32(module, 1), makeInt32(module, 2), makeInt32(module, 3)]
        ),
        BinaryenArrayGet(
            module,
        ...
        BinaryenArraySet(
            module, BinaryenGlobalGet(module, 'i8Array-global', i8Array), makeInt32(module, 0), makeInt32(module, 42)
        ),
        BinaryenArrayLen(module, BinaryenGlobalGet(module, 'i8Array-global', i8Array)),
        BinaryenArrayCopy(
            module,
            BinaryenGlobalGet(module, 'i8Array-global', i8Array),
            makeInt32(module, 0),
        ...
        BinaryenStringNew(
            module, BinaryenStringNewUTF8(), makeInt32(module, 0), makeInt32(module, 0), None, None, False
        ),
        BinaryenStringNew(
            module, BinaryenStringNewUTF8(), makeInt32(module, 0), makeInt32(module, 0), None, None, True
        ),
        BinaryenStringNew(
            module, BinaryenStringNewWTF8(), makeInt32(module, 0), makeInt32(module, 0), None, None, False
        ),
        BinaryenStringNew(
            module, BinaryenStringNewReplace(), makeInt32(module, 0), makeInt32(module, 0), None, None, False
        ),
        BinaryenStringNew(
            module, BinaryenStringNewWTF16(), makeInt32(module, 0), makeInt32(module, 0), None, None, False
        ),
        BinaryenStringNew(
            module,
        ...
        BinaryenStringNew(module, BinaryenStringNewFromCodePoint(), makeInt32(module, 1), None, None, None, False),
        BinaryenStringConst(module, 'hello world'),
        BinaryenStringMeasure(
            module, BinaryenStringMeasureUTF8(), BinaryenGlobalGet(module, 'string-global', BinaryenTypeStringref())
        ),
        BinaryenStringMeasure(
            module, BinaryenStringMeasureWTF8(), BinaryenGlobalGet(module, 'string-global', BinaryenTypeStringref())
        ),
        BinaryenStringMeasure(
            module, BinaryenStringMeasureWTF16(), BinaryenGlobalGet(module, 'string-global', BinaryenTypeStringref())
        ),
        BinaryenStringMeasure(
            module, BinaryenStringMeasureIsUSV(), BinaryenGlobalGet(module, 'string-global', BinaryenTypeStringref())
        ),
        BinaryenStringMeasure(
            module,
            BinaryenStringMeasureWTF16View(),
            BinaryenStringAs(
                module, BinaryenStringAsWTF16(), BinaryenGlobalGet(module, 'string-global', BinaryenTypeStringref())
            ),
        ),
        ...
        BinaryenStringAs(
            module, BinaryenStringAsWTF8(), BinaryenGlobalGet(module, 'string-global', BinaryenTypeStringref())
        ),
        BinaryenStringAs(
            module, BinaryenStringAsWTF16(), BinaryenGlobalGet(module, 'string-global', BinaryenTypeStringref())
        ),
        BinaryenStringAs(
            module, BinaryenStringAsIter(), BinaryenGlobalGet(module, 'string-global', BinaryenTypeStringref())
        ),
    ...
    BinaryenExpressionPrint(valueList[3])
    value = BinaryenBlock(module, 'the-value', valueList, BinaryenTypeAuto())
    ...
    sinker = BinaryenAddFunction(module, 'kitchen()sinker', iIfF, BinaryenTypeInt32(), localTypes, body)
    BinaryenAddGlobal(module, 'a-global', BinaryenTypeInt32(), False, makeInt32(module, 7))
    BinaryenAddGlobal(module, 'a-mutable-global', BinaryenTypeFloat32(), True, makeFloat32(module, 7.5))
    BinaryenAddGlobal(
        module,
        'i8Array-global',
        i8Array,
        True,
        BinaryenArrayNew(module, BinaryenTypeGetHeapType(i8Array), makeInt32(module, 0), None),
    )
    BinaryenAddGlobal(
        module,
        'i16Array-global',
        i16Array,
        True,
        BinaryenArrayNew(module, BinaryenTypeGetHeapType(i16Array), makeInt32(module, 0), None),
    )
    BinaryenAddGlobal(
        module, 'i32Struct-global', i32Struct, True, BinaryenStructNew(module, None, BinaryenTypeGetHeapType(i32Struct))
    )
    BinaryenAddGlobal(module, 'string-global', BinaryenTypeStringref(), True, BinaryenStringConst(module, ''))
    iF_ = [BinaryenTypeInt32(), BinaryenTypeFloat64()]
    iF = BinaryenTypeCreate(iF_)
    BinaryenAddFunctionImport(module, 'an-imported', 'module', 'base', iF, BinaryenTypeFloat32())
    ...
    BinaryenAddActiveElementSegment(module, '0', '0', funcNames, BinaryenConst(module, BinaryenLiteralInt32(0)))
    ...
    BinaryenExpressionPrint(BinaryenTableSet(module, '0', BinaryenConst(module, BinaryenLiteralInt32(0)), funcrefExpr1))
    funcrefExpr2 = BinaryenTableGet(module, '0', BinaryenConst(module, BinaryenLiteralInt32(0)), BinaryenTypeFuncref())
    ...
    starter = BinaryenAddFunction(module, 'starter', BinaryenTypeNone(), BinaryenTypeNone(), None, BinaryenNop(module))
...
def test_unreachable() -> None:
    module = BinaryenModuleCreate()
    body = BinaryenCallIndirect(
        module, 'invalid-table', BinaryenUnreachable(module), None, BinaryenTypeNone(), BinaryenTypeInt64()
    )
    fn = BinaryenAddFunction(module, 'unreachable-fn', BinaryenTypeNone(), BinaryenTypeInt32(), None, body)
    assert BinaryenModuleValidate(module)
    BinaryenModulePrint(module)
    BinaryenModuleDispose(module)
...
def test_relooper() -> None:
    module = BinaryenModuleCreate()
    localTypes = [BinaryenTypeInt32()]
    BinaryenAddFunctionImport(module, 'check', 'module', 'check', BinaryenTypeInt32(), BinaryenTypeNone())
    ...
    sinker = BinaryenAddFunction(module, 'just-one-block', BinaryenTypeNone(), BinaryenTypeNone(), localTypes, body)
    relooper = RelooperCreate(module)
    ...
    sinker = BinaryenAddFunction(module, 'two-blocks', BinaryenTypeNone(), BinaryenTypeNone(), localTypes, body)
    relooper = RelooperCreate(module)
    block0 = RelooperAddBlock(relooper, makeCallCheck(module, 0))
    block1 = RelooperAddBlock(relooper, makeCallCheck(module, 1))
    RelooperAddBranch(block0, block1, None, makeDroppedInt32(module, 77))
    body = RelooperRenderAndDispose(relooper, block0, 0)
    sinker = BinaryenAddFunction(
        module, 'two-blocks-plus-code', BinaryenTypeNone(), BinaryenTypeNone(), localTypes, body
    )
    relooper = RelooperCreate(module)
    block0 = RelooperAddBlock(relooper, makeCallCheck(module, 0))
    block1 = RelooperAddBlock(relooper, makeCallCheck(module, 1))
    ...
    body = RelooperRenderAndDispose(relooper, block0, 0)
    sinker = BinaryenAddFunction(module, 'loop', BinaryenTypeNone(), BinaryenTypeNone(), localTypes, body)
    relooper = RelooperCreate(module)
    block0 = RelooperAddBlock(relooper, makeCallCheck(module, 0))
    block1 = RelooperAddBlock(relooper, makeCallCheck(module, 1))
    ...
    body = RelooperRenderAndDispose(relooper, block0, 0)
    sinker = BinaryenAddFunction(module, 'loop-plus-code', BinaryenTypeNone(), BinaryenTypeNone(), localTypes, body)
    relooper = RelooperCreate(module)
    block0 = RelooperAddBlock(relooper, makeCallCheck(module, 0))
    block1 = RelooperAddBlock(relooper, makeCallCheck(module, 1))
    ...
    body = RelooperRenderAndDispose(relooper, block0, 0)
    sinker = BinaryenAddFunction(module, 'split', BinaryenTypeNone(), BinaryenTypeNone(), localTypes, body)
    relooper = RelooperCreate(module)
    block0 = RelooperAddBlock(relooper, makeCallCheck(module, 0))
    block1 = RelooperAddBlock(relooper, makeCallCheck(module, 1))
    block2 = RelooperAddBlock(relooper, makeCallCheck(module, 2))
    ...
    body = RelooperRenderAndDispose(relooper, block0, 0)
    sinker = BinaryenAddFunction(module, 'split-plus-code', BinaryenTypeNone(), BinaryenTypeNone(), localTypes, body)
    relooper = RelooperCreate(module)
    block0 = RelooperAddBlock(relooper, makeCallCheck(module, 0))
    block1 = RelooperAddBlock(relooper, makeCallCheck(module, 1))
    block2 = RelooperAddBlock(relooper, makeCallCheck(module, 2))
    ...
    body = RelooperRenderAndDispose(relooper, block0, 0)
    sinker = BinaryenAddFunction(module, 'if', BinaryenTypeNone(), BinaryenTypeNone(), localTypes, body)
    relooper = RelooperCreate(module)
    block0 = RelooperAddBlock(relooper, makeCallCheck(module, 0))
    block1 = RelooperAddBlock(relooper, makeCallCheck(module, 1))
    block2 = RelooperAddBlock(relooper, makeCallCheck(module, 2))
    ...
    body = RelooperRenderAndDispose(relooper, block0, 0)
    sinker = BinaryenAddFunction(module, 'if-plus-code', BinaryenTypeNone(), BinaryenTypeNone(), localTypes, body)
    relooper = RelooperCreate(module)
    block0 = RelooperAddBlock(relooper, makeCallCheck(module, 0))
    block1 = RelooperAddBlock(relooper, makeCallCheck(module, 1))
    block2 = RelooperAddBlock(relooper, makeCallCheck(module, 2))
    ...
    body = RelooperRenderAndDispose(relooper, block0, 0)
    sinker = BinaryenAddFunction(module, 'if-else', BinaryenTypeNone(), BinaryenTypeNone(), localTypes, body)
    relooper = RelooperCreate(module)
    block0 = RelooperAddBlock(relooper, makeCallCheck(module, 0))
    block1 = RelooperAddBlock(relooper, makeCallCheck(module, 1))
    block2 = RelooperAddBlock(relooper, makeCallCheck(module, 2))
    ...
    RelooperAddBranch(block1, block2, None, None)
    body = RelooperRenderAndDispose(relooper, block0, 0)
    sinker = BinaryenAddFunction(module, 'loop-tail', BinaryenTypeNone(), BinaryenTypeNone(), localTypes, body)
    relooper = RelooperCreate(module)
    block0 = RelooperAddBlock(relooper, makeCallCheck(module, 0))
    block1 = RelooperAddBlock(relooper, makeCallCheck(module, 1))
    block2 = RelooperAddBlock(relooper, makeCallCheck(module, 2))
    ...
    body = RelooperRenderAndDispose(relooper, block0, 0)
    sinker = BinaryenAddFunction(
        module, 'nontrivial-loop-plus-phi-to-head', BinaryenTypeNone(), BinaryenTypeNone(), localTypes, body
    )
    relooper = RelooperCreate(module)
    ...
    to_block2 = [4]
    RelooperAddBranchForSwitch(block0, block2, to_block2, makeDroppedInt32(module, 55))
    RelooperAddBranchForSwitch(block0, block3, None, None)
    body = RelooperRenderAndDispose(relooper, block0, 0)
    sinker = BinaryenAddFunction(module, 'switch', BinaryenTypeNone(), BinaryenTypeNone(), localTypes, body)
    relooper = RelooperCreate(module)
    block0 = RelooperAddBlock(relooper, makeCallCheck(module, 0))
    block1 = RelooperAddBlock(relooper, makeCallCheck(module, 1))
    block2 = RelooperAddBlock(relooper, makeCallCheck(module, 2))
    ...
    body = RelooperRenderAndDispose(relooper, block0, 3)
    localTypes = [
        BinaryenTypeInt32(),
        BinaryenTypeInt32(),
        BinaryenTypeInt64(),
    ...
    sinker = BinaryenAddFunction(module, 'duffs-device', BinaryenTypeNone(), BinaryenTypeNone(), localTypes, body)
    relooper = RelooperCreate(module)
    listList = [makeCallCheck(module, 42), BinaryenReturn(module, makeInt32(module, 1337))]
    list = BinaryenBlock(module, 'the-list', listList, BinaryenTypeAuto())
    block = RelooperAddBlock(relooper, list)
    body = RelooperRenderAndDispose(relooper, block, 0)
    sinker = BinaryenAddFunction(module, 'return', BinaryenTypeNone(), BinaryenTypeInt32(), localTypes, body)
    printf('raw:\n')
    BinaryenModulePrint(module)
    assert BinaryenModuleValidate(module)
...
def test_binaries() -> None:
    ...
    adder = BinaryenAddFunction(module, 'adder', ii, BinaryenTypeInt32(), None, add)
    BinaryenSetDebugInfo(True)
    buffer, size = BinaryenModuleWrite(module, 1024)
...
def test_interpret() -> None:
    ...
    BinaryenAddFunctionImport(module, 'print-i32', 'spectest', 'print', BinaryenTypeInt32(), BinaryenTypeNone())
    callOperands = [makeInt32(module, 1234)]
    call = BinaryenCall(module, 'print-i32', callOperands, BinaryenTypeNone())
    starter = BinaryenAddFunction(module, 'starter', BinaryenTypeNone(), BinaryenTypeNone(), None, call)
    BinaryenSetStart(module, starter)
    BinaryenModulePrint(module)
    assert BinaryenModuleValidate(module)
...
def test_nonvalid() -> None:
    ...
    func = BinaryenAddFunction(
        ...
        BinaryenTypeNone(),
        localTypes,
        BinaryenLocalSet(module, 0, makeInt64(module, 1234)),
    )
    BinaryenModulePrint(module)
...
def test_for_each() -> None:
    module = BinaryenModuleCreate()
    fns = [
        BinaryenAddFunction(module, 'fn0', BinaryenTypeNone(), BinaryenTypeNone(), None, BinaryenNop(module)),
        BinaryenAddFunction(module, 'fn1', BinaryenTypeNone(), BinaryenTypeNone(), None, BinaryenNop(module)),
        BinaryenAddFunction(module, 'fn2', BinaryenTypeNone(), BinaryenTypeNone(), None, BinaryenNop(module)),
    ]
    for i in range(BinaryenGetNumFunctions(module)):
    ...
    for i in range(BinaryenGetNumExports(module)):
    ...
    BinaryenSetMemory(module, 1, 256, 'mem', segments, segmentPassive, segmentOffsets, segmentSizes, False, False, '0')
    BinaryenAddGlobal(module, 'a-global', BinaryenTypeInt32(), False, makeInt32(module, expected_offsets[1]))
    for i in range(BinaryenGetNumMemorySegments(module)):
        ...
        out = BinaryenCopyMemorySegmentData(module, i)
        assert segments[i] == out
    funcNames = [BinaryenFunctionGetName(fns[0]), BinaryenFunctionGetName(fns[1]), BinaryenFunctionGetName(fns[2])]
    constExprRef = BinaryenConst(module, BinaryenLiteralInt32(0))
    BinaryenAddTable(module, '0', 1, 1, BinaryenTypeFuncref())
    BinaryenAddActiveElementSegment(module, '0', '0', funcNames, constExprRef)
    ...
    for i in range(BinaryenElementSegmentGetLength(segment)):
        str = BinaryenElementSegmentGetData(segment, i)
...
def test_func_opt() -> None:
    ...
    add = BinaryenBinary(module, BinaryenAddInt32(), x, y)
    adder = BinaryenAddFunction(module, 'adder', BinaryenTypeNone(), BinaryenTypeInt32(), None, add)
...
def test_typebuilder() -> None:
    ...
    tempArrayType = TypeBuilderGetTempRefType(builder, tempArrayHeapType, 1)
    TypeBuilderSetArrayType(builder, tempArrayIndex, tempArrayType, BinaryenPackedTypeNotPacked(), True)
    tempStructIndex = 1
    tempStructHeapType = TypeBuilderGetTempHeapType(builder, tempStructIndex)
    tempStructType = TypeBuilderGetTempRefType(builder, tempStructHeapType, 1)
    fieldTypes = [tempStructType]
    fieldPackedTypes = [BinaryenPackedTypeNotPacked()]
    fieldMutables = [True]
    TypeBuilderSetStructType(builder, tempStructIndex, fieldTypes, fieldPackedTypes, fieldMutables)
    tempSignatureIndex = 2
    tempSignatureHeapType = TypeBuilderGetTempHeapType(builder, tempSignatureIndex)
    tempSignatureType = TypeBuilderGetTempRefType(builder, tempSignatureHeapType, 1)
    paramTypes = [tempSignatureType, tempArrayType]
    TypeBuilderSetSignatureType(
        builder, tempSignatureIndex, TypeBuilderGetTempTupleType(builder, paramTypes), tempSignatureType
    )
    tempBasicIndex = 3
    TypeBuilderSetBasicHeapType(builder, 3, BinaryenTypeGetHeapType(BinaryenTypeEqref()))
    assert TypeBuilderIsBasic(builder, tempBasicIndex)
    assert TypeBuilderGetBasic(builder, tempBasicIndex) == BinaryenTypeGetHeapType(BinaryenTypeEqref())
    ...
    tempSubStructType = TypeBuilderGetTempRefType(builder, tempSubStructHeapType, 1)
    fieldTypes = [tempStructType, BinaryenTypeInt32()]
    fieldPackedTypes = [BinaryenPackedTypeNotPacked(), BinaryenPackedTypeInt8()]
    fieldMutables = [True, False]
    TypeBuilderSetStructType(builder, tempSubStructIndex, fieldTypes, fieldPackedTypes, fieldMutables)
    ...
    assert BinaryenArrayTypeGetElementPackedType(arrayHeapType) == BinaryenPackedTypeNotPacked()
    ...
    assert BinaryenStructTypeGetFieldPackedType(structHeapType, 0) == BinaryenPackedTypeNotPacked()
    ...
    basicHeapType = heapTypes[tempBasicIndex]
    ...
    assert BinaryenHeapTypeIsSubType(subStructHeapType, BinaryenHeapTypeStruct())
    ...
    assert BinaryenStructTypeGetFieldType(subStructHeapType, 1) == BinaryenTypeInt32()
    assert BinaryenStructTypeGetFieldPackedType(subStructHeapType, 0) == BinaryenPackedTypeNotPacked()
    assert BinaryenStructTypeGetFieldPackedType(subStructHeapType, 1) == BinaryenPackedTypeInt8()
    ...
    BinaryenAddFunction(module, 'test', BinaryenTypeNone(), BinaryenTypeNone(), varTypes, BinaryenNop(module))
